...
fakemodel::fakemodel(string type) {
	//name = type;

}

//void fakemodel::build(float lookupdown, float sceneroty,float xtrans,float ytrans,float ztrans) {
//
//	if(displayType != true) {
...
//}
//
//void fakemodel::moveModel(float lookupdown, float sceneroty,float xtrans,float ytrans,float ztrans,int a) {
//
//}
//
//
//void fakemodel::modelHit() {
//
//}
//
//void fakemodel::updateModel() {
//
//}
//
//int fakemodel::updateState() {
//	return 2;
//}
//
//int fakemodel::getOverallState() {
//	return 0;
//}
//
//void fakemodel::calculateMath() {
//	for(int a = 0; a<display.getPolys().size() - 1;a++) {
//		display.getPolys()[a]->vNorm = calculateNormal(display.getPolys()[a]);
//	}
//}
//void fakemodel::buildModel(float lookupdown, float sceneroty,float xtrans,float ytrans,float ztrans) {
...
//}
//
//void fakemodel::buildList(float lookupdown, float sceneroty,float xtrans,float ytrans,float ztrans) {
//	moveModel(lookupdown,sceneroty,xtrans,ytrans,ztrans,0);
//	glCallList(displayList);
//}
//
//vector<float> fakemodel::calculateNormal(polygon* poly) {
//	vector<float> vN1;
//	vector<float> vN2;
//	vector<float> vNorm;
//	vector<float> p1;
